...
export const TypingBox = () => {
  ...
  return (
    <div className='z-10 max-w-[600px] flex space-y-6 flex-col bg-gradient-to-tr  from-slate-300/30 via-gray-400/20 to-slate-600-400/20 p-4  backdrop-blur-sm rounded-xl border-slate-100/30 border'>
      <div>
